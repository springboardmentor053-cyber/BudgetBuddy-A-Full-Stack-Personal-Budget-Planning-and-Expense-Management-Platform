...
# This project uses Django's built-in ``auth.User`` model. The ``users`` app
# only provides the related Profile model, so no custom user model or
# authentication backend is configured here.
