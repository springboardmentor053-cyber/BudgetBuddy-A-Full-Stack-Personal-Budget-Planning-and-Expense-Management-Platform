...
import io
import matplotlib
matplotlib.use("Agg")  # CRITICAL for Vercel: prevents GUI/display crashes
    ...
    def get(self, request, *args, **kwargs):
        ...
        # ----------------------------------------------------
            ...
            try:
                ...
                elements.append(
                    Paragraph("1. Executive Summary", section_heading))
                summary_data = [
                    ["Metric", "Amount"],
                ...
                for bgt in budgets:
                    bgt_table_data.append([
                        str(bgt.id),
                        str(getattr(bgt, "category", getattr(
                            bgt, "period", "Budget"))),
                ...
                svg_t = Table(svg_table_data, colWidths=[
                              50, 190, 100, 100, 100])
