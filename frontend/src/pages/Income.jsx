...
function Income() {
    ...
    const totalIncome = useMemo(() => {
        return incomeList.reduce(
            (total, income) => total + Number(income.amount || 0), 0
        );
    }, [incomeList]);
    ...
    return (
        <div className="income-page">
            ...
            <div className="income-header">
                <div>
                    <div className="income-eyebrow">PERSONAL FINANCE</div>
                    <h1>Income</h1>
            ...
            <div className="income-summary-grid">
                ...
                <div className="income-summary-card">
                    ...
                    <div>
                        ...
                        <strong>{incomeList.length}</strong>
                ...
                <div className="income-summary-card">
                    ...
                    <div>
                        ...
                        <strong>
                            {latestIncome ? formatCurrency(latestIncome.amount) : "₹0"}
                        </strong>
                        <small>
                            {latestIncome ? getSourceLabel(latestIncome.source) : "No records yet"}
                        </small>
                    </div>
                </div>
            ...
            <div className="income-content-grid">
                ...
                <section className="income-form-card">
                    ...
                    <div className="income-card-header">
                        <div>
                            <h2>{editingId ? "Update Income" : "Add Income"}</h2>
                            <p>{editingId ? "Update the selected income record." : "Add a new source of income."}</p>
                        </div>
                    ...
                    <form className="income-form" onSubmit={saveIncome}>
                        ...
                        <div className="income-form-actions">
                            ...
                            {editingId && (
                                <button type="button" className="income-secondary-btn" onClick={clearForm}>
                                    Cancel
                                </button>
                            )}
                        </div>
                ...
                <section className="income-history-card">
                    ...
                    <div className="income-history-header">
                        <div>
                            ...
                            <p>Your recent income transactions</p>
                        </div>
                        <span className="income-count">{filteredIncome.length}</span>
                    </div>
                                        ...
                                        <tr key={income.id}>
                                            ...
                                            <td>
                                                <div className="income-title-cell">
                                                    <div className="income-row-icon">
                                                        <i className={`bi ${getSourceIcon(income.source)}`}></i>
                                                    </div>
                                            ...
                                            <td>
                                                <span className="income-description">
                                                    {income.description || <em style={{ opacity: 0.4 }}>—</em>}
                                                </span>
                                            </td>
