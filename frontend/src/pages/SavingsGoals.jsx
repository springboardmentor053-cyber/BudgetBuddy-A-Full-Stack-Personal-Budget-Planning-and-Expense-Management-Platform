...
function SavingsGoals() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!formData.title || !formData.target_amount) {
      setError("Please enter a goal title and target amount.");
      return;
    }
    ...
    <div className="dashboard-layout">
      ...
      <main className="savings-main">
        <header className="savings-header">
          <p className="dashboard-eyebrow">Savings goals</p>
        ...
        <section className="savings-grid">
          <div className="savings-form-card">
            <h2>
              {editingId ? "Update Goal" : "Create Savings Goal"}
            </h2>
                    ...
                    <article className="goal-card" key={goal.id}>
                      ...
                      <div className="goal-amounts">
                        ...
                        <div>
                          <span>Remaining</span>
                          <strong>
                            ₹{Number(goal.remaining_amount).toFixed(2)}
                          </strong>
                        </div>
                      </div>
